...
class HealthLogDao {
    ...
    HealthLogDao(HealthLogDynamoDbClient dynamoDbClient) {
     ...
     * @return
     */
     HealthLogMetrics getHealthLogMetrics(Session session) {
     ...
     * @param metrics
     */
    void saveHealthLogMetrics(HealthLogMetrics metrics) {
        HealthLogUserDataItem item = new HealthLogUserDataItem()
